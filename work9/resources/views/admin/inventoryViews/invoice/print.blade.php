...
<body>
    <div class="clearfix">
        ...
        <img src="{{ public_path('kandk_logo.jpg') }}" alt="logo"
            ...
            {{-- <img src="{{ asset('kandk_logo.jpg') }}" alt="logo"
            style="float:left; vertical-align:middle; padding-bottom: 20px; padding-top: 30px;"> --}}
        <h1
    ...
    <div id="footer">
        ...
        <h5 style="line-height: 50%; text-align: left;"> Received Person Name : ................................
            Customer Stamp : ..............................Signature : ...................... Date : ................
        </h5>

        <h6 style="margin-top: -5px; text-align: left; line-height: 50%;">Cheques to be drawn in favour of K & K
            International Lanka Pvt Ltd. Crossed A/C Payee Only. <strong>Number of Credit ............. Days</strong>
        </h6>

        <h6 style="margin-top: -15px; text-align: left; line-height: 50%;">Account Name : K & K INTERNATIONAL LANKA PVT
            LTD</h6>
        <h6 style="margin-top: -15px; text-align: left;">Bank Account Numbers: </h6>
        <h6 style="margin-top: -15px; padding-left: 20px; text-align: left; line-height: 50%;">Seylan Bank Mount Lavinia
            003000653670001 </h6>
        <h6 style="margin-top: -20px; padding-left: 20px; text-align: left; line-height: 50%;">Nations Trust Bank Mount
            Lavinia 100520004774 </h6>
        <h6 style="margin-top: -20px; padding-left: 20px; text-align: left; line-height: 50%;">Hatton National Bank
            Ratmalana 208010004809 </h6>
    </div>
