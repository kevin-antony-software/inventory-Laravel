...
@section('content')
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="number" id="repairCharges" name="repairCharges" value="{{ $job->repairCharges }}">
        </div>
        <div class="form-group">
            <label for="totalCharges">Total Charges</label>
            <input class="form-control" type="number" id="totalCharges" name="totalCharges" value="{{ $job->totalCharges }}">
        </div>
        <div class="form-group">
    ...
    <div class="container-fluid pt-5">
        <h3> Issue </h3>
        <textarea class="form-control" type="textarea" id="issue" name="issue" rows="5" cols="30">{{ $job->issue }}</textarea>
    </div>
    <div class="container pt-5">
        <div class="form-group">
            <a class="btn btn-danger" href="{{ route('jobs.index') }}"> @lang('Cancel')</a>
            <input type="submit" class="btn btn-info " value="Close Job">
        </div>
    </div>
    </form>
